...
function Contact() {
  ...
  return (
    ...
    <div className='sm:flex-col p-10 sm:m-0 sm:p-0 sm:ml-6  shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] bg-white bg-opacity-50 rounded-[15px] overflow-hidden border-2 m-3  max-w-xs'>
    ...
    <div className=' rounded-[15px] sm:ml-6 border-lineblue bg-white  shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px]  m-3 max-w-xs'>
    ...
    <div className=' md:mr-[25%] sm:mr-0 h-screen w-[50%] sm:h-[60%] sm:mt-[30%] sm:w-full sm:mr-0  flex items-center justify-center content-center'>
      ...
      <div className='sm:flex sm:content-center sm:items-center sm:justify-center'><h2 className=' -mt-20'>Escríbenos</h2></div>
        <input type="text" name='name' placeholder='Escribe tu nombre' className='w-[100%] p-3 bg-opacity-[5%]  border-solid placeholder-navi bg-textarea border-[1px] border-inputline rounded-[15px] outline-inputhover text-[15px] focus:ring-hoveline focus:border-inputhover block' required/>
        <input type="email" name='email' placeholder='Escribe tu correo electronico' className=' p-3 bg-opacity-[5%]  w-[100%] placeholder-navi bg-textarea  border-inputline border-solid border-[1px] outline-inputhover text-[15px] rounded-[15px]' required/>
        <textarea name="message" rows="7" placeholder='Escribe tu mensaje' className='w-full p-3 border-solid bg-opacity-[5%] placeholder-navi bg-textarea border-inputline border-[1px]  sm:m-0 w-[100%] outline-inputhover text-[15px] rounded-[15px]' required></textarea>
        <div className='sm:flex sm:content-center sm:items-center sm:justify-center'><button type='submit' className='btn btn-primary bg-naviblue text-white font-bold text-[14px] rounded-[15px] placeholder-navi  outline-inputhover text-[15px] p-3 w-[30%] sm:w-[70%]'>Enviar Mensaje</button></div>
      </form>
      </div>
